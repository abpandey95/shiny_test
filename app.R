...
# User interface ----
ui <- navbarPage(title="Data Visulaization App", fluid = TRUE,
                 tabPanel("European DataSet",
                          ...
                          # Define the sidebar with one input
                          sidebarPanel(width = 4,
                                       numericInput('variableC', 'Cluster count (1- 8)', 3,
                                                    min = 1, max = 8)),
                          br(),
                          br(),
                          br(),
                 ...
                 tabPanel("Bar Plor for Countries", 
